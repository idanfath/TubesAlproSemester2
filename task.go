...
func TaskPage() {
	var tasks = Tasks{
		...
		{id: 14, nama: "Nonton film di Letterboxd", prioritas: 3, durasi: 130, date: Date{year: 2026, month: 6, day: 20}, selesai: true},
		...
		{id: 18, nama: "Laundry baju harian", prioritas: 3, durasi: 30, date: Date{year: 2026, month: 6, day: 22}, selesai: true},
		...
		{id: 23, nama: "Gunting rambut", prioritas: 3, durasi: 45, date: Date{year: 2026, month: 6, day: 24}, selesai: true},
		{id: 24, nama: "Evaluasi mingguan tubes", prioritas: 1, durasi: 60, date: Date{year: 2026, month: 6, day: 24}, selesai: false},
		{id: 25, nama: "Rest day / Santai", prioritas: 3, durasi: 240, date: Date{year: 2026, month: 6, day: 25}, selesai: false},
	}
